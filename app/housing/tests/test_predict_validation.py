...
def _prediction_request(client, urlparams):
    return client.get("/housing/predict?" + urlencode(urlparams))
        ...
        "detail": [
            {
                ...
                "msg": "Input should be '<1H OCEAN', 'INLAND', 'ISLAND', 'NEAR BAY' or 'NEAR OCEAN'",
                "input": "NOT_A_VALID_VALUE",
                "ctx": {"expected": "'<1H OCEAN', 'INLAND', 'ISLAND', 'NEAR BAY' or 'NEAR OCEAN'"},
